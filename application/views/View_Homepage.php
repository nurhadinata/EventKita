...
<html lang="en">
    ...
    <body>
    <header>
    <a href="<?php base_url("eventkita/home");?>" class="logo">EventKita<span>.</span></a>
        <ul class="navigation">
            <li><a href="<?php echo base_url('eventkita/home');?>">Home</a></li>
            <li><a href="<?php echo base_url('eventkita/Logevent');?>">Event</a></li>
            <li><a href="<?php echo base_url('eventkita/Logcontact');?>">Contact Us</a></li>
            <li><a href="<?php echo base_url("eventkita/user");?>">My Profile</a></li>
        </ul>
    </header>
        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="content">
                    <div>
                        <h2>Exhibition</h2>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quisquam minus tempora dolores quis iusto voluptates autem iste possimus vel, unde, error esse molestiae distinctio beatae quos ullam hic ea vitae!</p>
                    </div>
                </div>
            </div>
            <div class="card">
    ...
    <footer>
        <div class="footer-content">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta, nisi sunt. Repudiandae.</p>
            <ul class="social">
