...
<head>
  ...
  <link rel="icon" type="image/png" href="../asset1/logo2.png">
...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="white" data-active-color="danger">
      <div class="logo">
        <a href="../View_Homepage.php" class="simple-text logo-mini">
          <div class="logo-image-small">
            <img src="../asset1/logo2.png">
          </div>
          <!-- <p>CT</p> -->
        </a>
        <a href="../View_Homepage.php" class="simple-text logo-normal font-weight-bold text-capitalize">
          EventKita.
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link btn-magnify" href="../View_LandingPage.css">
